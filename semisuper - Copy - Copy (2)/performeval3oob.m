function [performancematAVG,performancematCAT]=performeval3oob(forest,ntree,x,testsamples,y,ytrains,settest,y_eval,x_eval,cattrg,allleavesy,xlblused,ylblused,xtrain,usedsampleslog)%ytrains=ytrainset{1,j}
