function[readyAVG,readyAVGExt,readyAVGExt2,readyAVGExt3,readyAVGExt4,readyAVGExt6,readyAVGExt7,readyCATS,readyCATExt,readyCATExt2,readyCATExt3,readyCATExt4,readyCATExt6,readyCATExt7]=...
    kfoldcvfulltreev2_1tekdeneinducT_distmat(x,y,nf,maxleafsize,maxdepth,ntree,sampfactor,cattrg,categories,categoriesx,sf,xIT,yIT,extdistmat)
...
for j=1:1%nf
  ...
  [forest1_1,usedsamps,testsamples,usedsampleslog,comb,allleaves,unl,allleavesy, allunlabeled]=dtforest3dis(x_eval,y_eval,ntree,sampfactor,xtrain,ytrain,maxleafsize,maxdepth,3,0,xfull(r(:,j),:),yfull(r(:,j),:),extdistmat);%rankbased için 2yi 1 yapkbased için 2yi 1 yap
